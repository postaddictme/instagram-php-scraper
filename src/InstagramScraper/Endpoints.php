...
class Endpoints
{
    ...
    const HIGHLIGHT_STORIES_URL = 'https://www.instagram.com/graphql/query/?query_hash=45246d3fe16ccc6577e0bd297a5db1ab&variables={"highlight_reel_ids":{reelIds},"precomposed_overlay":false}';
