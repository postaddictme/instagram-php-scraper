...
class Endpoints
{
    ...
    const LIKES_BY_SHORTCODE = 'https://www.instagram.com/graphql/query/?query_hash=d5d763b1e2acf209d62d22d184488e57&variables={"shortcode":"{{shortcode}}","first":{{count}},"after":"{{likeId}}"}';
